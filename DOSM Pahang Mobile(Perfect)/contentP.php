...
$idClicked = $_POST['valuePendapatan'];
$area = $idClicked;
...
<body>
    ...
    <div class="update">         
        <p id="pendapatan_daerah">Pendapatan Bulanan di Daerah <?php fetchArea($area);?></p> 
        <div class="content-daerah">
            ...
            <div class="w3-bar-block2 w3-black">
                <div class="w3-bar-item-penengah-daerah items">
                    ...
                    <p class="penengah_daerah_RM number"><?php fetchPenengah($area); ?></p>
                </div>
                <div class="w3-bar-item-purata-daerah items">
                    <p class="purata_daerah_RM">RM</p>
                    <p class="purata_daerah_RM number"><?php fetchPurata($area); ?></p>
                </div>
            </div>
        ...
        <script>
            ...
            var dpenengah = <?php fetchPenengah2($area)?>;
            var dpurata = <?php fetchPurata2($area)?>;
